...
- ![新圖示](../../assets/new.svg) **已新增對Adobe CommerceAdobe I/O事件的支援**。 擴充功能開發人員現在可以使用[Adobe I/O事件](https://developer.adobe.com/events/docs/)架構，將Commerce事件資訊從雲端執行個體傳送至其為[AdobeApp Builder](https://developer.adobe.com/app-builder/docs/overview/)撰寫的應用程式。 Adobe Commerce的Adobe I/O事件在合作夥伴預覽中。<!-- CEXT-932 -->
